...
\begin{titlepage}
    ...
    \vspace{1cm}
    \begin{center}
        \textbf{\large Mã đồ án: HK252-DATN-330} \\
    \end{center}
    \vspace{2cm}
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{rrl}
             ...
             & Sinh viên thực hiện:  & Hồ Sỹ Thắng - 2213188\\
        \end{tabular}
    \end{table}
...
\tableofcontents
\newpage
% Bản rút gọn không in danh mục hình và bảng để giảm số trang.
...
\setcounter{page}{1}
\input{tex/chapters/01_introduction}
\input{tex/chapters/02_background}
\input{tex/chapters/03_related_work}
\input{tex/chapters/04_system_proposal}
\input{tex/chapters/05_analysis_design}
\input{tex/chapters/06_implementation}
\input{tex/chapters/07_testing}
\input{tex/chapters/08_deployment}
\input{tex/chapters/09_conclusion}
