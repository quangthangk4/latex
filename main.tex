...
\fancyhead[L]{
 \begin{tabular}{rl}
    ...
    \put(0,-8){\includegraphics[width=8mm, height=8mm]{images/hcmut.jpg}}
    \end{picture}&
    \begin{tabular}{l}
...
\begin{titlepage}
    ...
    \begin{figure}[h!]
    \begin{center}
     \includegraphics[width=3cm]{images/hcmut.jpg}
    \end{center}
    \end{figure}
    ...
    \begin{center}
    \begin{tabular}{c}
    \textbf{\Large BÁO CÁO ĐỒ ÁN CHUYÊN NGÀNH - GĐ1}\\
    \\
    \hline
    \\
    ...
    \vspace{2cm}
    \begin{center}
    {\footnotesize TPHCM, tháng 10 năm 2025}
    \end{center}
\end{titlepage}

\newpage
% Đảm bảo bạn có các file này trong thư mục content/
\input{content/i.Loi_Cam_On}
\newpage
\input{content/ii.Tom_Tat}
\newpage
\input{content/phancong}
\newpage
...
% Nội dung chính
\input{content/I.Introdution_project}
\input{content/II.knowledgeAndTechnology}
\input{content/III.relatedWorks}
\input{content/IV.System_proposal}
\input{content/V.Analysis_and_Design}
\input{content/VI.implement}
\input{content/VII.chapter5_testing.tex}
\input{content/VIII.chapter6_deployment.tex}
\input{content/VI.Tong_Ket}
\input{content/VII.Resources}
% Tài liệu tham khảo
\newpage
